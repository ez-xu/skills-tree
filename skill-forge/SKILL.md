...
hooks:
  UserPromptSubmit:
    - hooks:
        - type: command
          command: python "C:/Users/15854/.claude/skills/skill-forge/scripts/hook_draft_inject.py" --mode prompt

  PreToolUse:
    - matcher: "Read|Glob|Grep|Bash"
      hooks:
        - type: command
          command: python "C:/Users/15854/.claude/skills/skill-forge/scripts/hook_draft_inject.py" --mode pretool

  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: python "C:/Users/15854/.claude/skills/skill-forge/scripts/hook_draft_inject.py" --mode posttool

  Stop:
    - hooks:
        - type: command
          command: python "C:/Users/15854/.claude/skills/skill-forge/scripts/skill_check.py"
---
...
```bash
python "C:/Users/15854/.claude/skills/skill-forge/scripts/phase0_load.py"
```
...
```bash
python "C:/Users/15854/.claude/skills/skill-forge/scripts/scan_structure.py"
```
...
```bash
python "C:/Users/15854/.claude/skills/skill-forge/scripts/init_draft.py" "<derived-name>" "<$ARGUMENTS>"
python "C:/Users/15854/.claude/skills/skill-forge/scripts/init_staging.py" "<derived-name>"
```
...
```bash
python "C:/Users/15854/.claude/skills/skill-forge/scripts/record_eval_score.py" <score>
python "C:/Users/15854/.claude/skills/skill-forge/scripts/finalize_skill.py" "<n>" --mode create
```
...
### Step 1: initialize draft + staging
```bash
python "C:/Users/15854/.claude/skills/skill-forge/scripts/init_improve.py" "<matched-name>"
```
...
2. Run optimization loop:
   ```bash
   python "C:/Users/15854/.claude/skills/skill-forge/scripts/optimize_description.py" \
...
```bash
python "C:/Users/15854/.claude/skills/skill-forge/scripts/record_eval_score.py" <score>
python "C:/Users/15854/.claude/skills/skill-forge/scripts/finalize_skill.py" "<n>" \
  --mode update \
